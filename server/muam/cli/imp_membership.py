# import_memberships.py - Reads a comma-separated list of Membership and adds them
import csv
import logging
import os
import sys
...
def import_csv():
    opts = get_opts('import_membership', 'Adds list of Membership to a muam',
                    {'f': 'filename'})
